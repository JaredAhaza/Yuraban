...
class RegisteredUserController extends Controller
{
    ...
    public function getSubCounties($county_name)
    {
        // Find county by name instead of ID
        $county = County::where('county_name', $county_name)->first();
        ...
        return response()->json([
            'status' => 'success',
            'data' => $county->sub_counties // Assuming you have a relationship set up
        ], 200);
    }
